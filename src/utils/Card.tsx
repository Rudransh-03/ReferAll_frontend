...
const Card = ({title, content, img} : HomeCard) => {
  return (
    <div className="rounded-lg p-2 bg-white w-3/4 md:w-2/4 lg:w-1/4 border-2 border-indigo-600 shadow-2xl hover:scale-105 transition duration-150 ease-in-out">
