...
const Intro = () => {
  return(
    <div className="pt-44 h-screen flex justify-center items-center -z-10 bg-black">
        <div className="ml-4">
            ...
            <div className="mt-8 text-xl text-gray-300 animate-slideDown">Just put in a referral request and let our community do the magic 🚀🚀!</div>
