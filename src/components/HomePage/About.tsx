...
const About = () => {
    ...
    return (
        <div className="bg-black h-4/6">
            <div id="animatedDiv" className="flex justify-center opacity-0 text-center">
                <div className="text-5xl md:text-6xl lg:text-6xl font-semibold text-white">
                    <span>What is </span>
                    <span className="bg-gradient-to-r from-indigo-700 to-violet-500 inline-block text-transparent bg-clip-text">
                        ReferAll?
                    </span>
                </div>
            </div>
            <div className="flex mt-12 text-lg text-gray-300 justify-center px-6 md:px-20 lg:px-56 text-center animate-scaleUp">
                <div>
