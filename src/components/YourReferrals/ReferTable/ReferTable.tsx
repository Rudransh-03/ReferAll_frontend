        ...
        <tbody>
          {data.map((post: any, index: number) => (
            <tr key={index} className="border-t">
              ...
              <td className="text-center border border-indigo-600 px-2 sm:px-4 py-2">{post.user.firstName}&nbsp;{post.user.lastName}</td>
              <td className="text-center border border-indigo-600 px-2 sm:px-4 py-2">{post.user.currentCompany},&nbsp;{post.user.currentTitle}</td>
